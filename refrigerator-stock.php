...
<head>
    ...
    <title>Manajemen Stok Kulkas - Warung Om Tante V2</title>
    ...
    <style>
        ...
        /* --- Stats Grid Modern --- */
        .stock-grid-modern {
            display: grid; grid-template-columns: repeat(auto-fit, minmax(160px, 1fr)); gap: 1.25rem; margin-bottom: 2rem;
        }
        .stock-card-modern {
        ...
        .product-input-group-modern:focus-within { border-color: #60a5fa; background: rgba(59, 130, 246, 0.05); }
        ...
        .qty-input:focus { border-color: #60a5fa; background: rgba(59, 130, 246, 0.1); }
        ...
        .realtime-counter-modern span { color: #60a5fa; font-weight: 800; font-size: 1.3rem; margin-left: 5px; }
        ...
        .modern-input:focus { outline: none; border-color: #60a5fa; background: rgba(0,0,0,0.6); }
        input[type="date"].modern-input::-webkit-calendar-picker-indicator { filter: invert(1); cursor: pointer; opacity: 0.6; }
        
        .btn-filter-modern { background: rgba(59, 130, 246, 0.15); color: #60a5fa; border: 1px solid rgba(59, 130, 246, 0.4); padding: 0.8rem 1.5rem; border-radius: 12px; font-weight: 700; cursor: pointer; transition: 0.3s; height: 100%;}
        ...
        .modal-modern {
            ...
            border: 1px solid rgba(255, 255, 255, 0.1); border-top: 4px solid #60a5fa;
...
<body>
        ...
        <main class="main-content">
            ...
            <div class="modern-page-header">
                <div class="header-content-wrapper">
                    ...
                    <div class="header-text-wrapper">
                        <h1>Manajemen Stok Kulkas (Resto)</h1>
                        <p>Kelola jumlah fisik deposit (masuk) dan withdraw (keluar) stok paket makanan.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="modern-card">
                <div class="modern-card-header" style="border-bottom: none; margin-bottom: 0; padding-bottom: 0;">
                    <h3><span>📦</span> Ringkasan Stok Kulkas Saat Ini</h3>
                </div>
            ...
            <div class="modern-card">
                ...
                <div class="modern-info-box">
                    ...
                    <div><strong>Penting:</strong> Masukkan <strong>jumlah per unit paket</strong> yang akan masuk (Deposit) atau keluar (Withdraw) dari stok kulkas Resto secara manual.</div>
                </div>
                            ...
                            <?php foreach ($stock_levels as $stock): ?>
                                <div class="product-input-group-modern">
                                    ...
                                    <input type="number" 
                                           ...
                                           min="0" 
                                           value="0"
                                           data-name="<?= htmlspecialchars(str_replace('_', ' ', $stock['product_name'])) ?>">
                                </div>
                            <?php endforeach; ?>
                        </div>
    ...
    <div id="confirmation-modal" class="modal-overlay">
        <div class="modal-modern">
            ...
            <div class="modal-desc" id="modal-desc-display">
                Pastikan jumlah yang dimasukkan sudah benar sebelum melanjutkan.
            </div>
    ...
    <script>
        ...
        function openModal(actionType) {
            ...
            if (totalItems === 0) {
                alert('Harap pilih minimal satu produk dengan jumlah lebih dari 0!');
                return;
            }
            ...
            if (actionType === 'deposit') {
                modalTitle.textContent = 'Konfirmasi Deposit Stok';
                modalIcon.innerHTML = '➕';
                ...
                modalTitle.textContent = 'Konfirmasi Withdraw Stok';
                modalIcon.innerHTML = '➖';
